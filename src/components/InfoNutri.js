  ...
  return (
    <div className='flex flex-col justify-center lg:flex-row w-full bg-slate-200 sm:flex-col'>
        <div className='flex flex-col justify-center p-4 sm:p-16 md:p-16'>
            <img className='rounded-3xl border-solid border-8 border-amber-200 shadow-2xl shadow-slate-600' src="https://cobblestonemedicineandrehab.com/wp-content/uploads/2021/01/fitness-nutrition-pic-1.png" alt="Nutrición" />
        </div>
        <div className='w-full lg:w-[50%] lg:flex-col lg:text-center justify-center text-black'>
            ...
            <div className='flex justify-center p-8'>
                <ul className='flex flex-wrap text-3xl sm:text-4xl lg:flex-col xl:text-5xl'>
                    ...
                    <li className='flex p-4'><VscCheck className='mr-2 border-solid border-2 border-amber-500 rounded-full'/>Salud</li>
